...
import PlantUMLToExcalidraw from "./PlantUMLToExcalidraw";
...
const TTDDialogBase = withInternalFallback(
  ...
  ({
    ...
    tab: "text-to-diagram" | "mermaid" | "plantuml";
  } & (
    | {
        onTextSubmit(
      ...
      >
        <TTDDialogTabs dialog="ttd" tab={tab}>
          {"__fallback" in rest && rest.__fallback ? (
            <p className="dialog-mermaid-title">
              {tab === "plantuml" ? t("plantuml.title") : t("mermaid.title")}
            </p>
          ) : (
            <TTDDialogTabTriggers>
              ...
              <TTDDialogTabTrigger tab="plantuml">
                {t("plantuml.label")}
              </TTDDialogTabTrigger>
            </TTDDialogTabTriggers>
          )}
          ...
          <TTDDialogTab className="ttd-dialog-content" tab="plantuml">
            <PlantUMLToExcalidraw
              mermaidToExcalidrawLib={mermaidToExcalidrawLib}
              isActive={tab === "plantuml"}
            />
          </TTDDialogTab>
        </TTDDialogTabs>
      </Dialog>
